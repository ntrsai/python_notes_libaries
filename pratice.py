...
dates = list(map(str, range(1, 6)))  # ['1', '2', '3', '4', '5']#doubt------------------------------------------------
...
print(week[::2])  # ['Mon', 'Wed', 'Fri']#doubtss------------------------------------------------------
...
print(sorted(words, key=len))  # ['is', 'apple', 'beautiful']#dobut------------------------------------------------------------
...
days.sort(key=lambda x: order.index(x))#doubut---------------------------------------------------------------------------------
...
print(sum(1 for ch in sentence if ch.lower() in 'aeiou'))#doubts---------------------------------------------------------------

# 13. Replace word
quote = 'Data is boring'
print(quote.replace('boring', 'fun'))#doubts----------------------------------------------------------------------
